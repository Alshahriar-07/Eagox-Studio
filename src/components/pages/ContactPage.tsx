...
export const ContactPage: React.FC<ContactPageProps> = ({ onNavigate }) => {
  ...
  const handleCopy = async (text: string, label: string) => {
    try {
      ...
      toast.error(`Unable to copy ${label.toLowerCase()}.`, 'Copy Failed');
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Formspree contact submission failed');
      }

      setSubmitted(true);

      toast.success(
        `Thank you ${formData.name}! Your message has been received by Eagox Studio.`,
        'Message Sent',
        6000
      );
      ...
      const msg =
        'Failed to send your message. Please try again or contact Eagox Studio directly.';
      setErrorMessage(msg);
  ...
  const faqs = [
    {
      ...
      a: 'Small websites and landing pages usually take 1 to 2 weeks. Full-stack web applications, Android apps, or desktop software typically take 2 to 4 weeks depending on project scope.',
    },
    {
      q: 'How does Eagox Studio handle payments and contracts?',
      a: 'Projects can be handled through clear milestone-based agreements. Payment methods and milestones are discussed and confirmed before development begins.',
    },
    {
      q: 'Do you provide maintenance and updates after launch?',
      a: 'Yes. Eagox Studio can provide post-launch bug fixes, updates, maintenance, monitoring, and ongoing development support.',
    },
    {
      q: 'How can I discuss my project requirements urgently?',
      a: 'Use the official WhatsApp button on the website for rapid project discussion and consultation.',
    },
  ];
    ...
    >
      ...
      <section className="space-y-4 max-w-3xl">
        ...
        <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
          Have an engineering inquiry, custom software proposal, or partnership
          opportunity? Fill out the form below or contact Eagox Studio directly.
        </p>
      </section>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 rounded-2xl bg-zinc-950 text-white border border-zinc-800 shadow-lg space-y-5">
            ...
            <div className="pt-3 border-t border-zinc-800/80 flex flex-wrap gap-2">
              <button
                ...
                onClick={() =>
                  handleCopy(
                    'https://alshahriarsowan.vercel.app/',
                    'Portfolio link'
                  )
                }
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-xs space-y-3">
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
              We treat project specifications and proprietary information with
              strict confidentiality. Mutual NDAs can be discussed before
            ...
            {submitted ? (
              <div className="py-12 text-center space-y-4 animate-fade-in">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400 max-w-md mx-auto">
                  Thank you, <strong>{formData.name}</strong>. Eagox Studio has
                  received your inquiry and will reply to{' '}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <h3 className="text-lg font-bold text-zinc-950 dark:text-white mb-2 font-mono">
                  Send Direct Inquiry
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300 font-mono">
                      Your Full Name *
                    </label>
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    <option value="General Project Inquiry">
                      General Project Inquiry
                    </option>
                    <option value="Custom Web Application">
                      Full-Stack Web Application
                    </option>
                    <option value="Modern Website / Portfolio">
                      Modern Website / Portfolio
                    </option>
                    <option value="Native Android / Mobile App">
                      Android / Mobile App
                    </option>
                    ...
                    <option value="Open Source & Sponsorship">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about the software you want to build, technology requirements, and target timeline..."
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      <span>Send Message to Eagox Studio</span>
